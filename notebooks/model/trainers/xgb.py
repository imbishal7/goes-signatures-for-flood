"""xgb baseline on the unified GOES cache (config.CACHE_DIR).

Location-free per-cell tabular baseline: gradient-boosted trees.
59 features/(cell,day) = goes 8*4 + glm 8*2 + daily 3 + lead 8. Imbalance via
scale_pos_weight; no image, no spatial-tolerance loss. Saves outputs/xgb.pkl.
