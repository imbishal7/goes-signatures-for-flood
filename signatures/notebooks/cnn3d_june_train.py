"""Standalone trainer for a simple same-day 3D-CNN flood model (June 2026).
...
torchrun (one process per GPU):
    ...
    NCCL_P2P_DISABLE=1 torchrun --nproc_per_node=2 cnn3d_june_train.py

(Single-GPU also works: `python cnn3d_june_train.py`.)
...
def main():
    ...
    if is_main:
        ckpt = ROOT / "signatures/notebooks/cnn3d_june.pt"
